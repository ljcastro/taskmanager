...
import (
	...
	"github.com/ljcastro/taskmanager/data"
	"github.com/ljcastro/taskmanager/models"
	"gopkg.in/mgo.v2"
	"gopkg.in/mgo.v2/bson"
)

// CreateNote Handler for HTTP Post - /notes
...
// GetNotesByTask Handler for HTTP Get - /notes/tasks/{id}
...
// GetNotes Handler for HTTP Get - /notes
...
// GetNoteById Handler for HTTP Get - /notes/{id}
...
// UpdateNote Handler for HTTP Put - /notes/{id}
...
// DeleteNote Handler for HTTP Delete - /notes/{id}
